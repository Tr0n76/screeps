...
function create(creps) {
	...
	if (createCreep('harvester', 4, [WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE])){
		return;
	}
	if(createCreep('upgrader', 4, [WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE])){
		return;
	}
	if(createCreep('repair', 2, [WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE])){
		return;
	}	
	if(createCreep('builder', 2, [WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE])){
		return;
	}	
	if(createCreep('guard', , [ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, TOUGH, TOUGH, TOUGH, TOUGH])){
		return;
	}          
}
