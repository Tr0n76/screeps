...
function create() {
	...
	if(createCreep('builder', 4, [WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE])){
		return;
	}	
	if(createCreep('guard', 2, [ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, TOUGH, TOUGH, TOUGH, TOUGH])){
		return;
	}
